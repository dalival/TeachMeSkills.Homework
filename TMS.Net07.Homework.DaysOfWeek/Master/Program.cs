...
namespace Master
{
    class Program
    {
        ...
        {
            int amountOfDaysReferencePoint = CalculateAmountOfDays(30, 1, 2021);
            int amountOfDays = CalculateAmountOfDays(day, month, year);
            int difference = (amountOfDays - amountOfDaysReferencePoint) % 7;
